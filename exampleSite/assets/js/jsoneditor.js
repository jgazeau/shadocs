...
window.examplePostProcessFunction = function examplePostProcessFunction(
  schema,
  json,
) {
...
window.exampleFilenameToDownloadFunction =
  function exampleFilenameToDownloadFunction(schema, json) {
